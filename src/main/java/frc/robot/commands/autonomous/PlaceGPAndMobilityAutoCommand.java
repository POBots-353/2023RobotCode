...
public class PlaceGPAndMobilityAutoCommand extends SequentialCommandGroup {
  

  /** Creates a new Auto Command. */
  public PlaceGPAndMobilityAutoCommand(DriveSubsystem driveSubsystem) {
    ...
    addCommands(
      ...
      //Robot will be facing the node, and will drive backward the calculated distance to cross mobility line 
