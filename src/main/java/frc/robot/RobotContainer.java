...
public class RobotContainer {
    ...
    public Command placeConeAutoStart(Command pathPlannerCommand) {
        return Commands.sequence(PathPlannerUtil.eventMap.get("elevatorTiltOut"),
                PathPlannerUtil.eventMap.get("elevatorConeHigh"), PathPlannerUtil.eventMap.get("outtakeCone"),
                pathPlannerCommand);
    }
