...
public class RobotContainer {
    ...
    private void configureBindings() {
        ...
        driverController.y().whileTrue(new DriveToSquaredCommand(driveSubsystem));
        ...
        motorIntake.onFalse(Commands.run(transitSubsystem::stopClawMotors, transitSubsystem));// trigger claw motors
                                                                                              // on/off
